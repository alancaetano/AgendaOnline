...
using AgendaOnline.Client.Properties;
using Xamarin.Forms;

namespace AgendaOnline.Client.Seedwork
{
    public class ViewModelBase : INotifyPropertyChanged
    {
        ...
        public Task ShowAsync()
        {
            ...
            string viewModelName = "AgendaOnline.Client.Views." + GetType().Name.Replace("ViewModel", "") + "Page";
