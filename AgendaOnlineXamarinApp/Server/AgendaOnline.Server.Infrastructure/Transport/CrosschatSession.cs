...
{
    public class AgendaOnlineSession : AppSession<AgendaOnlineSession, BinaryRequestInfo>, ISession
    {
        private new static readonly ILogger Logger = LogFactory.GetLogger<AgendaOnlineSession>();
