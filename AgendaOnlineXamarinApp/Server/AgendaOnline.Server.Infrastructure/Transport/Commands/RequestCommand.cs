...
using AgendaOnline.Server.Application.Services;
...
{
    public class RequestCommand : AgendaOnlineCommandBase
    {
        protected new readonly ILogger Logger = LogFactory.GetLogger<RequestCommand>();

        protected override bool AllowAnonymousAccess { get { return true; } }

        public override async void ExecuteAstralCommand(AgendaOnlineSession session, byte[] data)
        {
